//服务器地址
_serverAddress = _server + "/cod_cus/codCusApplyInterfaceMapping/list";
//跳转页面
_jumpPage = baselocation + "/views/cod_cus/codCusApplyInterfaceMapping/";
//操作数组
var columns=[
    { title: "",field: "select",radio: true,width: 20,align: "left",valign: "middle"},
    { title: "应用接口编码",field: "applyId",align: "left",sortable: true,order: "desc"},
    { title: "接口信息",field: "interfaceInfo",align: "left",sortable: true },
