//服务器地址
_serverAddress = _server + "/cod_cus/codCusCustomsrel/list";
//跳转页面
_jumpPage = baselocation + "/views/cod_cus/codCusCustomsrel/";
//操作数组
columns = [
    { title: "",field: "select",radio: true,width: 20,align: "left",valign: "middle"},
    {title: "口岸海关代码", field: "customsCode", align: "left", sortable: true, order: "desc"},
