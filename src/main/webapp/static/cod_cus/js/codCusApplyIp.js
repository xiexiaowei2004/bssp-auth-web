//服务器地址
_serverAddress = _server+"/cod_cus/codCusApplyIp/list";
//跳转页面
_jumpPage = baselocation+"/views/cod_cus/codCusApplyIp/";
//操作数组
columns=[
    { title: "",field: "select",radio: true,width: 20,align: "left",valign: "middle"},
    { title: "应用IP编码",field: "applyId",align: "left",sortable: true,order: "desc"},
    { title: "应用IP",field: "applyIp",align: "left",sortable: true },
