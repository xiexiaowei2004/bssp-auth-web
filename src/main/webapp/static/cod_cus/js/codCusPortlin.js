//服务器地址
_serverAddress = _server + "/cod_cus/codCusPortlin/list";
//跳转页面
_jumpPage = baselocation + "/views/cod_cus/codCusPortlin/";
//操作数组
columns = [
    { title: "",field: "select",radio: true,width: 20,align: "left",valign: "middle"},
    {title: "序号", field: "pkSeq", align: "left", sortable: true, order: "desc"},
    {title: "港口航线中文", field: "portCCod", align: "left", sortable: true},
    {title: "港口航线英文", field: "portECod", align: "left", sortable: true},
    {title: "航线", field: "portLine", align: "left", sortable: true},
    {title: "总数", field: "portCount", align: "left", sortable: true},
    {title: "港口代码", field: "portCode", align: "left", sortable: true},
    {title: "隔离", field: "quarantine", align: "left", sortable: true},
    /*{
