//服务器地址
_serverAddress = _server+"/cod_std/codStdBusType/list";
//跳转页面
_jumpPage = baselocation+"/views/cod_std/codStdBusType/";
//操作数组
var columns=[
    // { title: "",field: "select",radio: true,width: 20,align: "left",valign: "middle"},
    {title: "申请表类别", field: "code", align: "center", sortable: true, order: "desc"},
    {title: "申请表名称", field: "name", align: "left", sortable: true},
