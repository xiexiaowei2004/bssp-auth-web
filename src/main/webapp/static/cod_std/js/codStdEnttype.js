//服务器地址
var _serverAddress = _server+"/cod_std/codStdEnttype/list";
//跳转页面
var _jumpPage = baselocation+"/views/cod_std/codStdEnttype/";
//操作数组
var columns=[
    // { title: "",field: "select",radio: true,width: 20,align: "left",valign: "middle"},
    { title: "企业类型代码",field: "code",align: "center",sortable: true,order: "desc"},
    { title: "企业类型名称",field: "name",align: "left",sortable: true },
