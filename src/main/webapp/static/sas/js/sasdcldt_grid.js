...
//页面绑定事件
$(function(){
	param.url=_serverAddress + "?sasDclNo="+sasDclNo+"&mtpckEndprdTypecd="+mtpckEndprdTypecd;
...
function save() {
   ...
   /* //拼接主键
    ...
    var url = _server + "/sas/sasDclDt/list/getSasDclCusDt?optype="+optype;
            ...
            success: function (result) {
                if (result.code == 1) {
                    /*layer.msg(result.message, {time: 1500}, function () {
                        ...
                        Utils.redirect("../sasDclDt/edit.jsp?optype=change");
