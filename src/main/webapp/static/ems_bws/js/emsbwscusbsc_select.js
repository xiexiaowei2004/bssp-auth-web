...
function Determine() {
    ...
    var serverUrl = _server + "/ems_bws/emsBwsCusBsc/list/generateChgData";
    $.ajax({
        url: serverUrl,
        type: 'post',
        ...
        success: function (result) {
            if (result.code == 1) {
                layer.msg("账册选择成功", {time: 1000}, function () {
                    var editUrl = baselocation + "/views/ems_bws/emsBwsBsc/edit.jsp?optype=modify&id=" + result.data.uid;
