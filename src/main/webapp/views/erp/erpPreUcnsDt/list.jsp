...
<div class="container animated fadeInRight">
            ...
            <div class="ibox-content">
                <div class="row m-b-sm">
                    ...
                    <div class="col-md-3 form-horizontal">
                        <label class="col-sm-3 control-label text-right text-nowrap">单耗版本号</label>
                        <div class="col-sm-9">
                    ...
                    <div class="col-md-5 form-horizontal">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" class="form-control input-sm datepicker" name="createTimeStart" id="createTimeStart" data-date-format="yyyy-mm-dd">
                                <span class="input-group-addon">到</span>
                                <input type="text" class="form-control input-sm datepicker" name="createTimeEnd" id="createTimeEnd" data-date-format="yyyy-mm-dd">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 form-horizontal">
    ...
    <!--ibox-->
    <div class="ibox-title font-bold">企业原始单耗</div>
    <div class="ibox-content">
        <div class="row">
            <div class="col-md-12">
                ...
                <span class="m-r-sm"></span>
                <a href="javascript:void(0);" class="btn btn-info fa fa-sign-in" id="getMidUcns">导入中间表</a>
                <a href="javascript:void(0);" class="btn btn-info fa fa-file-o" id="genEmsPurUcns">生成备案单耗</a>
...
<script src="../../../static/erp/js/erpPreUcnsDt_grid.js"></script>
</body>
</html>