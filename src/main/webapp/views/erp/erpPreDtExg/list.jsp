...
<div class="container animated fadeInRight">
            ...
            <div class="ibox-content">
                <div class="row m-b-sm">
                    ...
                    <div class="col-md-4 form-horizontal">
                        <label class="col-sm-4 control-label text-nowrap text-right">成品料号</label>
                        <div class="col-sm-8">
    ...
    <!--ibox-->
    <div class="ibox-title font-bold">企业原始成品</div>
    <div class="ibox-content">
        <div class="row">
            <div class="col-md-12">
                ...
                <span class="m-r-sm"></span>
                <a href="javascript:void(0);" class="btn btn-info fa fa-sign-in" id="getMidExg">导入中间表</a>
                <a href="javascript:void(0);" class="btn btn-info fa fa-cubes" id="genEmsPurExg">生成备案成品</a>
...
<script src="../../../static/erp/js/erpPreDtExg_grid.js"></script>
</body>
</html>