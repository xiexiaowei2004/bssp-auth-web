            ...
            <div class="ibox-content">
                <div class="row m-b-sm">
                    <div class="col-md-6 form-horizontal">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="emsNo" id="emsNo" class="form-control input-sm">
                        </div>
                    </div>
                    <div class="col-md-6 form-horizontal">
                        <label class="col-sm-4 control-label text-nowrap text-right">企业内部编号</label>
                        <div class="col-sm-8">
                            <input type="text" name="etpsPreentNo" id="etpsPreentNo" class="form-control input-sm">
                        </div>
                    </div>
                </div>
                <div class="row m-b-sm">
                    <div class="col-md-6 form-horizontal">
                        <label class="col-sm-4 control-label text-nowrap text-right">经营企业社会信用代码</label>
                        <div class="col-sm-8">
                            <input type="text" id="bizopEtpsSccd" name="bizopEtpsSccd" class="form-control input-sm">
                        </div>
                    </div>
                    <div class="col-md-6 form-horizontal">
...
<script src="../../../static/erp/js/emsPutrecBsc_select.js"></script>
<script>
    $(function () {
        load(false);
    });
