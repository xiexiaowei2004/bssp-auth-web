	...
	<form id="searchForm">
		...
		<div class="ibox">
			...
			<div class="ibox-content">
				...
				<div class="row m-b-sm">
					<div class="col-md-4 form-horizontal">
						<label class="col-sm-5 control-label text-nowrap text-right">过滤条件</label>
						<div class="col-sm-7">
	...
	<div class="ibox-content">
		<div class="row">
			<div class="col-md-12">
				...
				<span class="m-r-sm"></span>
				<a href="javascript:void(0);" class="btn btn-info fa fa-sign-in" id="getMidBondInvt">导入中间表</a>
				<a href="javascript:void(0);" class="btn btn-info fa fa-file-o" id="genBondInvt">生成核注清单</a>
...
<script src="../../../static/erp/js/erpPreBondInvtBsc_grid.js"></script>
</body>
</html>