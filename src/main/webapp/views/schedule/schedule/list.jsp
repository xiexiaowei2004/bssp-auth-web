...
<div class="container animated fadeInRight">
				...
				<div class="ibox-content">
					<div class="row m-b-sm">
						<div class="col-md-6 form-horizontal">
							<label class="col-sm-3 control-label text-nowrap text-right">任务名称</label>
							<div class="col-sm-9">
								<input type="text" class="form-control Col-sm-6" name="jobName" value="" />
							</div>
						</div>
						<div class="col-md-6 form-horizontal">
							<label class="col-sm-3 control-label text-nowrap text-right">任务分组</label>
							<div class="col-sm-9"> 
                               <input type="text" class="form-control Col-sm-6" name="jobGroup" value="">
							</div>
						</div>
 ...
 <!--ibox-->
	<div class="ibox-title font-bold">企业代码</div>
		<div class="ibox-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<span class="m-r-sm">
						...
						<a href="#1" class="btn btn-info fa fa-remove" id="delete" onclick=" operateType('delete')">删除</a>
						<a href="#1" class="btn btn-info fa fa-remove" id="resume" onclick="operateType('resume')">恢复</a>
						<a href="#1" class="btn btn-info fa fa-remove" id="pause" onclick="operateType('pause')">暂停</a>
					</span>
