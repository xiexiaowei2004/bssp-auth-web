                ...
                <form id="form" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-4">
                            ...
                            <button class="btn btn-primary" type="button" id="reback" onclick="Utils.redirect('../../../views/cod_biz/codBizBusParam/list.jsp')">返回</button>
                        </div>
                    </div>
                </form>
            </div>
...
<tiziFooter>
    ...
    <!-- 自定义js -->
    <script src="../../../static/cod_biz/js/codBizBusParam.js"></script>
</tiziFooter>
<script>
    $(function () {
        FormUtils.getData();
