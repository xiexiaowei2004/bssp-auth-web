...
<div class="container animated fadeInRight">
    <div class="ibox">
        <div class="ibox-title font-bold"> <h5>风险参数-查阅</h5>
                ...
                <form id="form" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="text-center">
                            <a href="#1" class="btn btn-info fa fa-mail-reply" id="reback" onclick="Utils.redirect('../../../views/cod_biz/codBizRskParam/list.jsp')">返回</a>
                        </div>
                    </div>
                </form>
            </div>
...
<tiziFooter>
    ...
    <!-- 自定义js -->
    <script src="../../../static/cod_biz/js/codBizRskParam_form.js"></script>
</tiziFooter>
</body>
</html>