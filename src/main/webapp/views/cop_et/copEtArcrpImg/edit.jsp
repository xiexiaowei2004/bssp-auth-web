    ...
    <div class="ibox-content">
        <form id="dataForm">
            ...
            <div class="form-group">
                ...
                <input type="hidden" value="I" id="mtpckEndprdTypecd" name="mtpckEndprdTypecd"/>
                <input type="hidden" value="料件" id="mtpckEndprdTypename" name="mtpckEndprdTypename"/>
            </div>
                    ...
                    <td>
                        <div class="form-group" style="width:260px;">
                            <input onkeyup="this.value=this.value.replace(/\D/g,'')" class="form-control" style="width:260px;" id="gdecd" name="gdecd" minlength="4" maxlength="4"
                                   placeholder="输入4位编码回车选择商品" style="width:260px;" fieldName="商品编码" isValidate="true" notempty/>
                        </div>
                    </td>
