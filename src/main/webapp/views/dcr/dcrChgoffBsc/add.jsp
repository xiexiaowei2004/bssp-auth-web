                ...
                <form id="dataForm">
                    ...
                    <table class="table table-condensed no-borders no-margins">
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <input class="input-sm form-control" id="emsNo" name="emsNo" isValidate="true" maxlength="64" notempty>
                                </div>
                            </td>
                            <td class="table-label text-nowrap text-right">报核次数<span class="notempty">*</span></td>
                            <td>
                                <div class="form-group">
                                    <input class="input-sm form-control" id="chgTmsCnt" name="chgTmsCnt" isValidate="true" maxlength="11" notempty readonly>
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <input class="input-sm form-control" id="dclEtpsNm" name="dclEtpsNm" isValidate="true" maxlength="512" notempty>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <input type="text" class="form-control datepicker" data-date-format="yyyy-mm-dd"
                                           id="chgoffBeginTime" name="chgoffBeginTime" isValidate="true" notempty>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <input type="text" class="form-control datepicker" data-date-format="yyyy-mm-dd"
                                           id="chgoffDueTime" name="chgoffDueTime" isValidate="true" notempty>
                                </div>
                            </td>
                ...
                <div class="tab-content">
                    <div  class="tab-pane fade in active m-t-sm" id="invtLtTab">
                        <div id="invtLtToolbar" class="m-t-sm">
                            ...
                            <span class="m-r-sm"></span>
                            <a href="javascript:void(0)" class="btn btn-info fa fa-plus-square" id="invtLtCheck">选取</a>
                        </div>
                    ...
                    <div  class="m-t-sm tab-pane fade" id="imgTab">
                        <div id="imgToolbar" class="m-t-sm">
                            ...
                            <span class="m-r-sm"></span>
                            <a href="javascript:void(0)" class="btn btn-info fa fa-plus-square" id="imgCheck">核算</a>
                        </div>
