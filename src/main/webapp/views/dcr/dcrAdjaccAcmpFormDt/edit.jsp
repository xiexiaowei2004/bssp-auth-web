                ...
                <form id="dataForm">
                    ...
                    <table class="table table-condensed no-border">
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <input class="input-sm form-control" type="number" placeholder="请输入随附单证序号" readonly id="acmpFormSeqno" name="acmpFormSeqno" isValidate="true" notempty>
                                </div>
                            </td>
                            <td class="table-label text-nowrap" >随附单证类型<span class="notempty">*</span></td>
                            <td>
                                <div class="form-group">
                                    <select class="form-control select2 form-horizontal" id="acmpFormTypecd" name="acmpFormTypecd" style="width: 100%"
                                            dll_name="ACMP_FORM_TYPECD" isShowEmpty="true" isValidate="true" notempty>
                                    </select>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td class="table-label text-nowrap">随附单证编号<span class="notempty">*</span></td>
                            <td>
                                <div class="form-group">
                                    <input class="input-sm form-control" placeholder="请输入随附单证编号" id="acmpFormno" name="acmpFormno" isValidate="true" notempty>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <input class="input-sm form-control" id="acmpFormFileNm" name="acmpFormFileNm" fieldName="随附单证文件名称" isValidate="true" notempty readonly>
                                </div>
                            </td>
...
<footer>
    ...
    <script src="../../../static/dcr/js/dcradjaccacmpformdt_form.js"></script>
</footer>
</body>
</html>