                ...
                <div class="col-md-12">
                    <div class="ibox-content">
                        <ul id="tab" class="nav nav-tabs">
                            <li class="queue active"><a href="#auditTab" data-toggle="tab">申报报文队列</a></li>
                            <li class="log" ><a href="#storageTab" data-toggle="tab">申报报文日志</a></li>

                        </ul>

                        <div class="tab-content">
                            <a href="#1" class="btn btn-info fa fa-refresh" id="refresh" style="margin: 20px 0 0 0;">刷新</a>
                            <a href="#1" class="btn btn-info fa fa-info-circle" id="find" style="margin: 20px 0 0 0;"> 查阅</a>
                            <%--<a href="#1" class="btn btn-info fa fa-edit" id="modify">修改</a>--%>

                            <a href="#1" class="btn btn-danger fa fa-edit" id="reset" style="margin: 20px 0 0 0;">重置</a>

                            <div class="tab-pane fade  fade m-t-sm active in" id="auditTab">
                                <table id="ediSendQueueTable"></table>
                            </div>
                            <div class="tab-pane fade m-t-sm " id="storageTab">
                                <table id="ediSendLogTable"></table>
