...
<body class="gray-bg">
    <div class="container animated fadeInRight">
                ...
                <div class="ibox-content">
                    ...
                    <div class="row m-b-sm">
                        <div class="col-md-4 form-horizontal">
                            <label class="col-sm-4 control-label text-nowrap text-right">编号</label>
                            <div class="col-sm-8">
                                <input type="text" name="serialNo" class="form-control input-sm">
                            </div>
                        </div>
                        <div class="col-md-4 form-horizontal">
        ...
        <!--ibox--><div class="ibox-title font-bold">报文收发处理日志</div>
        <div class="ibox-content">
            <div class="row">
                <div class="col-md-12">
