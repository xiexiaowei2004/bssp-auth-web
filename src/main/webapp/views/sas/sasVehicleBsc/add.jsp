    ...
    <div class="ibox-content">
        ...
        <form id="dataForm">
            ...
            <table class="table table-condensed no-border">
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            <div class="form-group">
                                <input class="input-sm form-control" id="dclPreentNo" name="dclPreentNo" readonly fieldName="申报端统一编号" isValidate="true" notempty>
                            </div>
                        </div>
                    </td>
                    <td class="table-label text-nowrap" style="width:160px;">企业预录入编号</td>
                    <td><input class="input-sm form-control" id="etpsPreentNo" name="etpsPreentNo" readonly></td>
                ...
                <tr>
                    <td class="table-label text-nowrap">车牌号<span style="color:red;">*</span></td>
                    <td>
                        <div class="form-group">
                            <input class="input-sm form-control" id="vehicleNo" name="vehicleNo" fieldName="车牌号" isValidate="true" notempty maxlength="64">
                        </div>
                    </td>
                    <td class="table-label text-nowrap">第二车牌号(境外)</td>
                    <td><input class="input-sm form-control" id="secVehicleIcNo" name="secVehicleIcNo"></td>
                    <td class="table-label text-nowrap">监管车海关编码</td>
                    <td>
                        <div class="form-group">
                            <input class="input-sm form-control" id="vehicleCusNo" name="vehicleCusNo" maxlength="10">
                        </div>
                    </td>
                </tr>
                <tr>
                    <td class="table-label text-nowrap">车辆类型<span style="color:red;">*</span>:</td>
                    <td>
                        <div class="form-group">
                    ...
                    <td class="table-label text-nowrap">车牌类型<span style="color:red;">*</span></td>
                    <td>
                        <div class="form-group">
                            <select class="form-control" id="plateTypecd" name="plateTypecd" dll_name="PLATE_TYPE" style="width: 100%"></select>
                        </div>
                    </td>
                    <td class="table-label text-nowrap">车辆自重(KG)<span style="color:red;">*</span></td>
                    <td>
                        <div class="form-group">
                            <input class="input-sm form-control" type="number" step="0.00001" id="vehicleWt" name="vehicleWt" fieldName="车辆自重" isValidate="true" notempty>
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="table-label text-nowrap">申报日期<span style="color:red;">*</span></td>
...
<footer>
    ...
    <script src="../../../static/sas/js/sasVehicleBsc.js"></script>
</footer>
</body>
</html>