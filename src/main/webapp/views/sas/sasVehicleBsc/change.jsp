		...
		<div class="ibox">
			<div class="ibox-content" style="padding-bottom: 0">
				<div class="row m-b-sm">
					...
					<div class="col-md-4 form-horizontal">
						<label class="col-sm-4 control-label text-nowrap text-right">所属企业名称</label>
						<div class="col-sm-8">
							<input type="text" name="etpsNm" class="form-control input-sm">
						</div>
					</div>
					<div class="col-md-4 form-horizontal">
						<label class="col-sm-2 control-label text-nowrap text-right">车辆类型</label>
						<div class="col-sm-10">
							<select class="form-control select2 form-horizontal" id="vehicleTypecd" name="vehicleTypecd" dll_name="codStdCarType" isShowEmpty="true"></select>
						</div>
					</div>
				</div>
...
<script src="../../../static/sas/js/sasVehicleChange.js"></script>
</body>
</html>