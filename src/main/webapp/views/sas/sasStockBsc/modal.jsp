		...
		<div class="ibox">
			<div class="ibox-content">
				<div class="row m-b-sm">
					...
					<div class="col-sm-4 form-horizontal">
						<label class="col-sm-4 control-label text-nowrap text-right">区域账册编号</label>
						<div class="col-sm-8">
							<input type="text" name="areainOriactNo" class="form-control input-sm">
						</div>
					</div>
					<div class="col-sm-4 form-horizontal">
						...
						<div class="col-sm-10">
							<div class="input-group">
								<input type="text" class="form-control input-sm datepicker" name="validTimeStart" id="validTimeStart" data-date-format="yyyy-mm-dd">
								<span class="input-group-addon">至</span>
								<input type="text" class="form-control input-sm datepicker" name="validTimeEnd" id="validTimeEnd" data-date-format="yyyy-mm-dd">
							</div>
						</div>
					</div>
				</div>
...
<script src="../../../static/sas/js/sasStockBscAdd_grid.js"></script>
</body>
</html>