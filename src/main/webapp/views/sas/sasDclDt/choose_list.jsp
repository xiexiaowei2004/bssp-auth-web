            ...
            <%--<div class="row m-b-xxs">--%>
                <div class="row m-b-sm">
                    <form id="searchForm">
                        ...
                        <div class="col-sm-5 form-horizontal" id="mtpckEndprdTypecdDiv">
                            <label class="col-xs-4 control-label text-right text-nowrap">料件成品标志代码</label>
                            <div class="col-xs-8">
                                <select class="form-control select2 form-horizontal" id="mtpckEndprdTypecd"
                                        name="mtpckEndprdTypecd" dll_name="MTPCK_TYPECD"  isShowEmpty="true" isValidate="true" notempty>
                                </select>
                            </div>
                        </div>
...
<script src="../../../static/sas/js/sasdcldtchoose_grid.js"></script>
</body>
</html>