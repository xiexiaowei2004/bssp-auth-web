	    ...
	    <form id="dataForm">
	       <div class="ibox">
	            <div class="ibox-content">
	                ...
	                <%--<div class="row m-b-sm">--%>
	                    <%--<div class="col-xs-12 form-horizontal">--%>
	                        <%--<label class="col-xs-4 text-nowrap text-right">出入区<span class="notempty">*</span></label>--%>
							<%--<div class="col-xs-8">--%>
								<%--<div class="form-group">--%>
									<%--<label>--%>
									<%--<input type="radio" name="directionTypecd" checked>入区--%>
									<%--<!-- <span name="directionTypeNm"></span> -->--%>
								<%--</label>--%>
								<%--<label>--%>
									<%--<input type="radio" name="directionTypecd">出区--%>
									<%--<!-- <span name="directionTypeNm"></span> -->--%>
								<%--</label>--%>
								<%--</div>								--%>
							<%--</div>--%>
...
<footer>
	...
	<script src="../../../static/sas/js/sasDclModal.js"></script>
</footer>
</body>
</html>