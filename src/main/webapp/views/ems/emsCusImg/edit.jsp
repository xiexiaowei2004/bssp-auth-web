...
<body>
		    	...
		    	<form id="dataForm" role="form">			    	
			        <table class="table table-condensed noborder">
		                ...
		                <tr>			                			                
			                ...
			                <td>
				                <div class="form-group">
				                	<input class="form-control" id="dclQty" name="dclQty" type="number" step="0.01">
			                	</div>
			                </td>
			                <td class="table-label text-nowrap text-right">征免方式</td>
		                	<td>
		                		<select class="form-control"  id="lvyrlfModecd" name="lvyrlfModecd" dll_name="codCusLevymode" default="1" style="width:100%;"></select>
		                	</td>
		                </tr>
			            <tr>
			            	<td class="table-label text-nowrap text-right">主料标记<span style="color:#EE0000;">*</span></td>
			                <td>
		                		<div class="form-group">
			                		<select class="form-control"  id="adjmtrMarkcd" name="adjmtrMarkcd" dll_name="ADJMTR_MARK" default="1" fieldName="主料标记" isValidate="true" notempty style="width:100%;"></select>
		                		</div>		                
			                </td>
		                ...
		                <tr>
		                	...
		                	<td><input class="form-control" id="vclrPridInitQty" name="vclrPridInitQty" type="number" readonly></td>
			                ...
			                <td>
			                	<div class="form-group">
		                			<select class="form-control"  id="cusmExeMarkcd" name="cusmExeMarkcd" dll_name="CUSM_EXE_MARKCD" default="0" fieldName="修改标记" isValidate="true" notempty style="width:100%;"></select>
		                		</div>
			                </td>
		                </tr>		           
			            <tr>
	...
	<footer>
	    ...
	    <script src="../../../static/ems/js/emscusimg_form.js"></script>
	</footer>
</body>
</html>