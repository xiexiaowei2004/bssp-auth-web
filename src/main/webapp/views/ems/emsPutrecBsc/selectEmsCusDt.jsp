            ...
            <div class="ibox-content">
                <div class="row m-b-sm">
                    <div class="col-sm-5 form-horizontal">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="gdsSeqno" class="form-control input-sm">
                        </div>
                    </div>
                    <div class="col-sm-5 form-horizontal">
                        <label class="col-sm-3 control-label text-nowrap text-right">料号</label>
                        <div class="col-sm-9">
...
<script src="../../../static/ems/js/emscusdt_select.js"></script>
</body>
</html>