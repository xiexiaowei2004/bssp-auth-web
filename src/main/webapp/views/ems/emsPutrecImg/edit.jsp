...
<body>
			...
			<div class="ibox-content">
				<form id="dataForm" role="form">
					...
					<div style="display: none;">
						...
						<input
							type="hidden" id="seqNo" name="seqNo"> 
					...
					<table class="table table-condensed noborder">
						<tr>
							<td class="table-label text-nowrap text-right">序号<span class="notempty">*</span></td>
							<td>
								<div class="form-group">
									<input class="form-control" type="number" id="gdsSeqno" name="gdsSeqno" fieldName="商品序号" isValidate="true" notempty>
								</div>
							</td>
							<td class="table-label text-nowrap text-right">料号<span class="notempty">*</span></td>
							<td>
								<div class="form-group">
							...
							<td>
								<div class="form-group">
									<input class="form-control" id="gdecd" name="gdecd"  placeholder="输入4位编码回车选择商品" isValidate="true" notempty>
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="form-group">
									<select class="form-control" id="dclUnitcd" name="dclUnitcd" dll_name="codCusUnit" style="width:100%;" isShowEmpty="true" isValidate="true" notempty></select>
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="form-group">
									<select class="form-control" id="lawfUnitcd" name="lawfUnitcd" dll_name="codCusUnit" default="" fieldName="法定计量单位"
							...
							<td>
								<div class="form-group">
									<select class="form-control" id="secdLawfUnitcd" default="" 
										name="secdLawfUnitcd" dll_name="codCusUnit" style="width:100%;"></select>
								</div>
							</td>
							<td class="table-label text-nowrap text-right">币制</td>
							<td>
								<div class="form-group">
									<select class="form-control" id="dclCurrcd" name="dclCurrcd" isShowEmpty="true" 
										dll_name="codCusCurr" style="width:100%;"></select>
								</div>
							</td>							
						</tr>
						<tr>
							...
							<td>
								<div class="form-group">
									<input class="form-control" id="dclUprcAmt" name="dclUprcAmt" type="number" step="0.00001">
								</div>
							</td>
							...
							<td>
								<select class="form-control" id="lvyrlfModecd" name="lvyrlfModecd" dll_name="codCusLevymode" isShowEmpty="true" style="width:100%;"></select>
							</td>
						</tr>
						<tr>
							<td class="table-label text-nowrap text-right">主料标记<span class="notempty">*</span></td>
							<td>
								<div class="form-group">
									<select class="form-control" id="adjmtrMarkcd"
										name="adjmtrMarkcd" dll_name="ADJMTR_MARK" default="1" 
										fieldName="主料标记" isValidate="true" notempty style="width:100%;"></select>
								</div>
							</td>
							<td class="table-label text-nowrap text-right">企业执行标记<span class="notempty">*</span></td>
							<td>
								<div class="form-group">
									<select class="form-control" id="etpsExeMarkcd"
										name="etpsExeMarkcd" dll_name="ETPS_EXE_MARK" default="1"
										fieldName="企业执行标记" isValidate="true" notempty style="width:100%;"></select>
								</div>
							</td>
						...
						<tr>
							...
							<td>
								<div class="form-group">
									<input class="form-control" id="vclrPridInitQty" name="vclrPridInitQty" type="number" readonly>
								</div>
							</td>
							<td class="table-label text-nowrap text-right">数量控制标记</td>
							<td>
								<div class="form-group">
									<select class="form-control" id="qtyCntrMarkcd" name="qtyCntrMarkcd" dll_name="QTY_CNTR_MARKCD"
										fieldName="企业执行标记" isValidate="true" notempty style="width:100%;"></select>
								</div>
							</td>
							...
							<td>
								<div class="form-group">
									<select class="form-control" id="cusmExeMarkcd" name="cusmExeMarkcd" dll_name="CUSM_EXE_MARKCD" default="0"
										fieldName="修改标记"  style="width:100%;"></select>
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<div class="form-group">
									<input class="form-control" type="number" id="apprMaxSurpQty" step="0.01" name="apprMaxSurpQty" readonly>
								</div>
							</td>
	...
	<footer>
		...
		<script src="../../../static/ems/js/emsputrecimg_loadEvent.js"></script>
