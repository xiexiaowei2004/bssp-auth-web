...
<body> 
		    	...
		    	<form id="dataForm">
			        ...
			        <table class="table table-condensed noborder">
			            <tr>
			                ...
			                <td>
			                	<div class="form-group">
				               		<input class="form-control" id="gdsSeqno" name="gdsSeqno" type="number" fieldName="商品序号" isValidate="true" notempty>
				               	</div>	
			                </td>	                
			                ...
			                <td>
			                	<div class="form-group">
				               		<input class="form-control" id="gdecd" name="gdecd" maxlength="10" type="tel" placeholder="输入4位编码回车选择商品" fieldName="商品编码" isValidate="true" notempty>
				               	</div>	
			                </td>
			            ...
			            <tr>			            	
			                ...
			                <td>
			                	<div class="form-group">
			                		<select class="form-control"  id="dclUnitcd" name="dclUnitcd" dll_name="codCusUnit" isShowEmpty="true" style="width:100%;" isValidate="true" notempty></select>
			                	</div>
		                	</td>
		              	</tr>
			            <tr>			                
			                ...
			                <td>
				                <div class="form-group">
				                	<select class="form-control"  id="dclCurrcd" name="dclCurrcd" isShowEmpty="true" dll_name="codCusCurr" style="width:100%;"></select>
			                	</div>
			                </td>			                
		                </tr>
		                <tr>			                
							...
							<td>
								<div class="form-group">
									<input class="form-control" id="dclQty" name="dclQty" type="number" step="0.00001">
								</div>
							</td>
			                <td class="table-label text-nowrap text-right">征免方式</td>
		                	<td>
		                		<select class="form-control"  id="lvyrlfModecd" name="lvyrlfModecd" isShowEmpty="true" dll_name="codCusLevymode" style="width:100%;"></select>
		                	</td>
		                </tr>
			            <tr>
	...
	<footer>
	    ...
	    <script src="../../../static/ems/js/emsputrecexg_loadEvent.js"></script>
	    <script src="../../../static/common/js/common.js"></script>
	    <script src="../../../static/ems/js/emsputrecexg_form.js"></script>
	</footer>
</body>
</html>