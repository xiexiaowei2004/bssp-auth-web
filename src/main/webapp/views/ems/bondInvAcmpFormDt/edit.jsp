            ...
            <div class="box-body no-margin" id="head">
                <form id="dataForm">
                    <div style="display:none;">
                        ...
                        <input type="hidden" id="bondInvtNo" name="bondInvtNo">
                    </div>
                    <table class="table table-condensed no-border">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-group">
                                    <input class="input-sm form-control" placeholder="请输入随附单证编号" id="formNo" name="formNo" isValidate="true" notempty>
                                </div>
                            </td>
...
<footer>
    ...
    <script src="../../../static/bond/js/invacmpformdt_form.js"></script>
</footer>
</body>
</html>