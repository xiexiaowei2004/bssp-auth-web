        ...
        <div class="ibox-title font-bold">    <h5>企业类型-查阅</h5>
            ...
            <div class="ibox-content">
                <form id="form" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label col-sm-offset-1">企业类型名称：</label>
                        <div class="col-sm-4 m-t-sm">
                    ...
                    <div class="form-group">
                        <div class="text-center">
                            <a href="#1" class="btn btn-info fa fa-mail-reply" id="reback" onclick="Utils.redirect('../../../views/cod_std/codStdEnttype/list.jsp')">返回</a>
                        </div>
                    </div>
                </form>
            </div>
