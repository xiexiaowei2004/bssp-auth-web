...
<div class="container animated fadeInRight">
        ...
        <div class="ibox-content">
            <form method="post" id="searchForm">
                <div class="row m-b-sm">
                    ...
                    <div class="col-sm-6 form-horizontal">
                        <label class="col-sm-3 control-label text-nowrap text-right">企业类型名称</label>
                        <div class="input-group col-sm-9">
                            <input type="text" maxlength="20" class="form-control" name="name" value="">
                        </div>
                    </div>
                </div>
                <div class="row">
    ...
    <!--ibox--><div class="ibox-title font-bold">企业类型</div>
    <div class="ibox-content">
        <div class="row">
            <div class="col-md-12">
