    ...
    <div class="col-sm-48">
        <div class="ibox float-e-margins">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label col-sm-offset-1">车辆分类编码<span style="color:red;">*</span>：</label>
                <div class="col-sm-4">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label col-sm-offset-1">车辆分类名称<span style="color:red;">*</span>：</label>
                <div class="col-sm-4">
                    <input type="text" class="form-control" name="name" id="name" placeholder="请填写车辆分类名称">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <div class="col-sm-offset-4">
                    ...
                    <button class="btn btn-primary" type="button" id="reback"
                            onclick="Utils.redirect('../../../views/cod_std/codStdCarSort/list.jsp')">返回
                    </button>
                </div>
            </div>
            </form>
