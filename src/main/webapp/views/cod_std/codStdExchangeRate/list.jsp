...
<div class="container animated fadeInRight">
            ...
            <form method="post" id="searchForm">
                <div class="row m-b-sm">
                    <div class="col-md-6 form-horizontal">
                        <label class="col-sm-3 control-label text-nowrap text-right">原币代码</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="code" value=""/>
                        </div>
                    </div>
                    <div class="col-sm-6 form-horizontal">
                        <label class="col-sm-3 control-label text-nowrap text-right">原币名称</label>
                        <div class="col-sm-9">
    ...
    <!--ibox--><div class="ibox-title font-bold">汇率维护</div>
    <div class="ibox-content">
        <div class="row">
            <div class="col-md-12">
