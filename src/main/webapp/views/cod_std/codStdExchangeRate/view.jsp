...
<div class="container animated fadeInRight">
    <div class="ibox">
        <div class="ibox-title font-bold">  <h5>汇率维护-查阅</h5>
            ...
            <div class="ibox-content">
                <form id="form" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4 m-t-sm">
                            <span id="eName" name="eName" class="view-span"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label col-sm-offset-1">兑人民币汇率：</label>
                        <div class="col-sm-4 m-t-sm">
                            <span id="rmbRate" name="rmbRate" class="view-span"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label col-sm-offset-1">兑美元汇率：</label>
                        <div class="col-sm-4 m-t-sm">
                            <span id="usdRate" name="usdRate" class="view-span"></span>
                        </div>
                    </div>
                    <div class="hr-line-dashed"></div>
                    <div class="form-group">
                        <div class="text-center">
                            <a href="#1" class="btn btn-info fa fa-mail-reply" id="reback" onclick="Utils.redirect('../../../views/cod_std/codStdExchangeRate/list.jsp')">返回</a>
                        </div>
                    </div>
                </form>
            </div>
