...
<div class="container animated fadeInRight">
            ...
            <form method="post" id="searchForm">
                <div class="row m-b-sm">
                    <div class="col-md-6 form-horizontal">
                        <label class="col-sm-3 control-label text-nowrap text-right">属性值</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="attrValue" value=""/>
                        </div>
                    </div>
                    <div class="col-sm-6 form-horizontal">
                        <label class="col-sm-3 control-label text-nowrap text-right">字典值</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="dictionaryValue" value="">
                        </div>
                    </div>
                </div>
                <div class="row m-b-sm">
    ...
    <!--ibox-->
    <div class="ibox-title font-bold">通用代码</div>
    <div class="ibox-content">
        <div class="row">
            <div class="col-md-12">
