...
<div class="container animated fadeInRight">
    <div class="ibox">
        <div class="ibox-title font-bold">  <h5>数据字典维护-查阅</h5>
                ...
                <form id="form" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4 m-t-sm">
                            <span id="attrValue" name="attrValue" class="view-span"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label col-sm-offset-1">属性名称：</label>
                        <div class="col-sm-4 m-t-sm">
                            <span id="attrName" name="attrName" class="view-span"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label col-sm-offset-1">字典值：</label>
                        <div class="col-sm-4 m-t-sm">
                            <span id="dictionaryValue" name="dictionaryValue" class="view-span"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label col-sm-offset-1">字典描述：</label>
                        <div class="col-sm-4 m-t-sm">
                            <span id="dictionaryDescript" name="dictionaryDescript" class="view-span"></span>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="text-center">
                            <a href="#1" class="btn btn-info fa fa-mail-reply" id="reback" onclick="Utils.redirect('../../../views/cod_std/codStdCodes/list.jsp')">返回</a>
                        </div>
                    </div>
                </form>
            </div>
