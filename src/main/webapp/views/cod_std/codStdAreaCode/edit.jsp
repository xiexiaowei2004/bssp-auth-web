            ...
            <div class="ibox-content">
                <form id="form" class="form-horizontal">
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" maxlength="10" class="form-control" id="areaCode" name="areaCode" placeholder="请填写五位监管场所">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label col-sm-offset-1">场地名称<span style="color:red;">*</span>：</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="areaName" name="areaName" placeholder="请填写场地名称">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label col-sm-offset-1">关区代码<span style="color:red;">*</span>：</label>
                        <div class="col-sm-4">
                        	 <input type="text" class="form-control"  name="customsCode" placeholder="请填写关区代码" style="display:none;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="visitUrlFirst" name="visitUrlFirst" placeholder="请填写访问地址">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label col-sm-offset-1">访问地址2：</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="visitUrlSec" name="visitUrlSec" placeholder="请填写访问地址">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label col-sm-offset-1">是否启用：</label>
                        <div class="col-sm-4">
                            <!-- <input type="text" class="form-control" id="isEnable" name="isEnable" placeholder="是否启用"> -->
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-4">
                            ...
                            <button class="btn btn-primary" type="button" id="reback" onclick="Utils.redirect('../../../views/cod_std/codStdAreaCode/list.jsp')">返回</button>
                        </div>
                    </div>
                </form>
            </div>
