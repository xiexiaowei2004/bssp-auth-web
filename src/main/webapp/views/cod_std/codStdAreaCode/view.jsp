...
<div class="container animated fadeInRight">
    <div class="ibox">
        <div class="ibox-title font-bold"><h5>监管场所-查阅</h5>
            ...
            <div class="ibox-content">
                <form id="form" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4 m-t-sm">
                            <span id="areaName" name="areaName" class="view-span"></span>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4 m-t-sm">
                            <span id="visitUrlFirst" name="visitUrlFirst" class="view-span"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label col-sm-offset-1">访问地址2：</label>
                        <div class="col-sm-4 m-t-sm">
                            <span id="visitUrlSec" name="visitUrlSec" class="view-span"></span>
                        </div>
                    </div>
                     <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="text-center">
                        	<a href="#1" class="btn btn-info fa fa-mail-reply" id="reback" onclick="Utils.redirect('../../../views/cod_std/codStdAreaCode/list.jsp')">返回</a>
                        </div>
                    </div>
                </form>
            </div>
