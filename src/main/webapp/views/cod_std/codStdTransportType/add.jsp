                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-10">
                                    <!-- <input type="text" class="form-control" name="regCoCgac" value="" /> -->
                                    <!-- <select dll_name="data"></select> -->
...
<tiziFooter>
    ...
    <script src="../../../static/cod_std/js/codStdTransportTypeAdd.js"></script>
</tiziFooter>
<script>
    $(function () {
        load(false);
