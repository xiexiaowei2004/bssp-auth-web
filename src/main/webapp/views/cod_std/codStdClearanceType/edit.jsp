            ...
            <div class="ibox-content">
                <form id="form" class="form-horizontal">
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" maxlength="10" class="form-control" id="code" name="code" placeholder="请填写通关业务代码">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label col-sm-offset-1">通关业务名称<span style="color:red;">*</span>：</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="name" name="name" placeholder="请填写通关业务名称">
                        </div>
                    </div>
