...
<div class="animated fadeInRight">
		...
		<div class="ibox">
			<div class="ibox-content">
				<div style="display: none;" id="hidSearchParam">
					&lt;%&ndash;<input type="hidden" name="chkStatus" value="P">&ndash;%&gt;<!-- 单据状态 -->
	...
	<form id="dtModalForm">
		<div class="ibox-content">
			<div class="row">
				<div class="col-md-12">
					<a href="javascript:void(0)" class="btn btn-info fa fa-check-square" id="dtModalSave">确认</a>
					<a href="javascript:void(0)" class="btn btn-default fa fa-mail-reply" id="dtModalReback">返回</a>
...
<script src="../../../static/saspass/js/simpleDtModal.js"></script>
</body>
</html>