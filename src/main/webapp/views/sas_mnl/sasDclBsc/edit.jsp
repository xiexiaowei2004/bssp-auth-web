    ...
    <div class="container animated fadeInRight">
        <div class="ibox" id="head">
            <div class="ibox-title with-border collapsed-box">
                <div class="pull-left">
                    <h4 class="box-title pull-left" id="headTitle">简单加工业务申请表头</h4>
                </div>
                <div class="pull-right">
                    <a href="javascript:;" class="collapse-link" title="收起表头"><i
                            class="fa fa-chevron-up"></i></a>
                </div>
            </div>
            <div class="clearfix"></div>
            <div class="ibox-content">
                <a href="javascript:void(0)" class="btn btn-info fa fa-save view" id="save">暂存</a>
                <a href="javascript:void(0)" class="btn btn-success fa fa-check-square-o view" id="submit">申报</a>
        ...
        <div class="ibox ja">
            <div class="ibox-title with-border collapsed-box">
                ...
                <div class="pull-right">
                    <a href="javascript:;" class="collapse-link" title="收起表体信息"><i
                            class="fa fa-chevron-up"></i></a>
                </div>
            </div>
            <div class="ibox-content">
                <ul id="tab" class="nav nav-tabs">
                    <li class="active"><a href="#imgTab" data-toggle="tab">加工前商品</a></li>
                    <li><a href="#exgTab" data-toggle="tab">加工后商品</a></li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade m-t-sm active in" id="imgTab">
                        <div id="imgToolbar" class="toolbar">
                            ...
                            <span class="m-r-sm"></span>
                            <a href="javascript:;" class="btn btn-info fa fa-info-circle" id="imgView">查阅</a>
                            <a href="javascript:;" class="btn btn-info fa fa-plus-square view" id="imgAdd">新增</a>
                            <a href="javascript:;" class="btn btn-info fa fa-edit view" id="imgEdit">修改</a>
                            <a href="javascript:;" class="btn btn-info fa fa-remove view" id="imgDelete">删除</a>
                            <span class="m-r-sm"></span>
                            <a href="javascript:;" class="btn btn-danger fa fa-edit change view" id="imgChangeEdit" style="display: none">变更修改</a>
                            <a href="javascript:;" class="btn btn-danger fa fa-remove change view" id="imgChangeRemove" style="display: none">变更删除</a>
                        </div>
                        <table   class="table-nowrap" id="imgTable"></table>
                    </div>
                    <!-- 成品 -->
                    <div class="tab-pane fade m-t-sm" id="exgTab">
                        <div id="exgToolbar" class="toolbar">
                            <a href="javascript:;" class="btn btn-info fa fa-refresh" id="exgRefresh">刷新</a>
                            <span class="m-r-sm"></span>
                            <a href="javascript:;" class="btn btn-info fa fa-info-circle" id="exgView">查阅</a>
                            <a href="javascript:;" class="btn btn-info fa fa-plus-square view" id="exgAdd">新增</a>
                            <a href="javascript:;" class="btn btn-info fa fa-edit view" id="exgEdit">修改</a>
                            <a href="javascript:;" class="btn btn-info fa fa-remove view" id="exgDelete">删除</a>
                            <span class="m-r-sm"></span>
                            <a href="javascript:;" class="btn btn-danger fa fa-edit change view" id="exgChangeEdit" style="display: none">变更修改</a>
                            <a href="javascript:;" class="btn btn-danger fa fa-remove change view" id="exgChangeRemove" style="display: none">变更删除</a>
                        </div>
                    ...
                    <div class="tab-pane fade m-t-sm" id="bomTab">
                        <div id="bomToolbar">
                            ...
                            <span class="m-r-sm"></span>
                            <a href="javascript:;" class="btn btn-info fa fa-info-circle" id="bomView">查阅</a>
                            <a href="javascript:;" class="btn btn-info fa fa-plus-square view" id="bomAdd">新增</a>
                            <a href="javascript:;" class="btn btn-info fa fa-edit view" id="bomEdit">修改</a>
                            <a href="javascript:;" class="btn btn-info fa fa-remove view" id="bomDelete">删除</a>
                            <span class="m-r-sm"></span>
                            <a href="javascript:;" class="btn btn-danger fa fa-edit change view" id="bomChangeEdit" style="display: none">变更修改</a>
                            <a href="javascript:;" class="btn btn-danger fa fa-remove change view" id="bomChangeRemove" style="display: none">变更删除</a>
                        </div>
        ...
        <!-- 附件信息 -->
        <div class="ibox ja" id="fileBox">
            <div class="ibox-title">
                <h4 class="box-title pull-left">随附单证</h4>
                <div class="pull-right">
                    <a href="javascript:;" class="collapse-link" title="收起"><i class="fa fa-chevron-down"></i></a>
                </div>
            </div>
            ...
            <div class="ibox-content" style="display:none;">
                <div id="fileToolbar"  class="toolbar">
                    ...
                    <a href="javascript:void(0)" class="btn btn-info fa fa-plus-square view" id="fileAdd">新增</a>
                    <a href="javascript:void(0)" class="btn btn-info fa fa-edit view" id="fileEdit">修改</a>
                    <a href="javascript:void(0)" class="btn btn-info fa fa-remove view" id="fileDelete">删除</a>
...
<footer>
    ...
    <script src="../../../static/sas_mnl/js/sasdclbsc_form.js"></script>
