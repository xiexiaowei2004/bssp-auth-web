            ...
            <div class="ibox-content">
                <div class="row m-b-sm">
                    ...
                    <div class="col-md-5 form-horizontal">
                        <label class="col-sm-3 control-label text-nowrap text-right">区内账册编号</label>
                        <div class="col-sm-9">
                            <input class="input-sm form-control" id="areainOriactNo" name="areainOriactNo">
                        </div>
                    </div>
                </div>
                <div class="row m-b-sm">
                    ...
                    <div class="col-md-5 form-horizontal">
                        <label class="col-sm-3 control-label text-nowrap text-right">操作时间</label>
                        <div class="col-sm-9">
    ...
    <div class="ibox-content">
        ...
        <div class="row m-t-sm">
            <div class="col-md-12" id="buttonGroup">
                ...
                <span class="m-r-sm"></span>
                <a href="javascript:void(0)" class="btn btn-danger fa fa-exclamation-circle" id="businessChange">变更</a>
                <a href="javascript:void(0)" class="btn btn-danger fa fa-exclamation-circle" id="businessColse">结案</a>
                <span class="m-r-sm"></span>
...
<script src="../../../static/sas_mnl/js/sasdclbsc_grid.js"></script>
</body>
</html>