...
<div class="container animated fadeInRight">
    <div class="ibox">
        <div class="ibox-title font-bold"><h5>接口-查阅</h5>
            ...
            <div class="ibox-content">
                <form id="form" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <span id="interfaceId" name="interfaceId" class="view-span"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label col-sm-offset-1">接口名称<span
                                style="color:red;">*</span>：</label>
                        <div class="col-sm-4">
                            <span id="interfaceName" name="interfaceName" class="view-span"></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label col-sm-offset-1">接口地址<span
                                style="color:red;">*</span>：</label>
                        <div class="col-sm-4">
                            <span id="interfaceUrl" name="interfaceUrl" class="view-span"></span>
                        </div>
                    </div>
                    <!--  <div class="form-group">
