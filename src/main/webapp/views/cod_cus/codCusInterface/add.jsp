            ...
            <div class="ibox-content">
                <form id="form" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" maxlength="10" class="form-control" name="interfaceId"
                                   placeholder="请填写接口编码">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label col-sm-offset-1">接口名称<span
                                style="color:red;">*</span>：</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="interfaceName" placeholder="请填写接口名称">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label col-sm-offset-1">接口地址<span
                                style="color:red;">*</span>：</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="interfaceUrl" placeholder="请填写接口地址">
                        </div>
                    </div>
                    <!--  <div class="form-group">
