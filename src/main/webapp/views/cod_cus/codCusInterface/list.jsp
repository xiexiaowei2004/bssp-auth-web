...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <form id="searchForm">
            ...
            <div class="ibox-content">
                <div class="row m-b-sm">
                    ...
                    <div class="col-md-3 form-horizontal">
                        <label class="col-sm-3 control-label text-nowrap text-right">接口编码</label>
                        <div class="col-sm-9">
                            <input type="text" id="interfaceId" name="interfaceId" class="form-control input-sm">
                        </div>
                    </div>
                    
                     <div class="col-md-4 form-horizontal">
                        <label class="col-sm-4 control-label text-nowrap text-right">接口名称</label>
                        <div class="col-sm-8">
                            <input type="text" id="interfaceName" name="interfaceName" class="form-control input-sm">
                        </div>
                    </div>
                    </div>
       ...
       <!--ibox-->
        <div class="ibox-title font-bold">接口维护</div>
    <div class="ibox-content">
