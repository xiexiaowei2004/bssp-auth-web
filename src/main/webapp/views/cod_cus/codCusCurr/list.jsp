...
<div class="container animated fadeInRight">
				...
				<div class="ibox-content">
					<div class="row m-b-sm">
						<div class="col-md-4 form-horizontal">
							<label class="col-sm-3 control-label text-nowrap text-right">币制代码</label>
							<div class="col-sm-9">
								<input type="text" class="form-control Col-sm-6" name="currCode" value="" />
							</div>
						</div>
						<div class="col-md-4 form-horizontal">
							<label class="col-sm-3 control-label text-nowrap text-right">英文简码</label>
							<div class="col-sm-9"> 
                               <input type="text" class="form-control Col-sm-6" name="currSymb" value="">
							</div>
						</div>
						<div class="col-md-4 form-horizontal">
							<label class="col-sm-3 control-label text-nowrap text-right">币制</label>
							<div class="col-sm-9"> 
                               <input type="text" class="form-control Col-sm-6" name="currName" value="">
							</div>
						</div>
 ...
 <!--ibox-->
	<div class="ibox-title font-bold">币制代码</div>
		<div class="ibox-content">
			<div class="row">
				<div class="col-md-12">
					<!-- <span class="m-r-sm">
                    ...
                    <form  method="post" id="searchForm">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="control-label">币制代码</label>
                                <div class="input-group col-sm-10">
                                    <input type="text" class="form-control" name="currCode" value="" />
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="control-label">英文简码</label>
                                <div class="input-group col-sm-10">
                                    <input type="text" class="form-control" name="currSymb" value="">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label class="control-label">币制</label>
                                    <div class="input-group col-sm-10">
                                        <input type="text" class="form-control" name="currName" value="" />
                            ...
                            <div class="example-wrap">
                                <div class="example">
                                    <div id="toolbar" class="btn-group m-t-sm">
                                        <button id="add" type="button" class="btn btn-default"  title="创建币制代码">
                                            <i class="glyphicon glyphicon-plus"></i>
                                        </button>
                                        <button id="delete" type="button" class="btn btn-default" title="删除币制代码">
