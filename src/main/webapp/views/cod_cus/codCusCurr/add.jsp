            ...
            <div class="ibox-content">
                <form id="form" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" maxlength="3" class="form-control" name="currCode" placeholder="请填写币制代码">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label col-sm-offset-1">英文简码<span style="color:red;">*</span>：</label>
                        <div class="col-sm-4">
                            <input type="text" maxlength="6" class="form-control" name="currSymb" placeholder="请填写英文简码">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label col-sm-offset-1">币制<span style="color:red;">*</span>：</label>
                        <div class="col-sm-4">
                            <input type="text" maxlength="24" class="form-control" name="currName" placeholder="请填写币制">
                        </div>
                    </div>
