...
<div class="container animated fadeInRight">
				...
				<div class="ibox-content">
					<div class="row m-b-sm">
						<div class="col-md-6 form-horizontal">
							<label class="col-sm-4 control-label text-nowrap text-right">主管外经贸部门代码</label>
							<div class="col-sm-8">
								<input type="text" class="form-control Col-sm-6" name="mftecCode" value="" />
							</div>
						</div>
						<div class="col-md-6 form-horizontal">
							<label class="col-sm-4 control-label text-nowrap text-right">主管外经贸部门名称</label>
							<div class="col-sm-8"> 
                               <input type="text" class="form-control Col-sm-6" name="mftecName" value="">
							</div>
						</div>
 ...
 <!--ibox-->
	<div class="ibox-title font-bold">主管外贸部门</div>
		<div class="ibox-content">
			<div class="row">
				<div class="col-md-12">
					<!-- <span class="m-r-sm">
                    ...
                    <form  method="post" id="searchForm">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="control-label">主管外经贸部门</label>
                                <div class="input-group col-sm-10" id="datepicker">
                                    <input type="text" class="form-control" name="mtecCode" value="" />
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="mftecName" value="">
                            ...
                            <div class="example-wrap">
                                <div class="example">
                                    <div id="toolbar" class="btn-group m-t-sm">
                                        <button id="add" type="button" class="btn btn-default"  title="创建主管外经贸部门">
                                            <i class="glyphicon glyphicon-plus"></i>
                                        </button>
                                        <button id="delete" type="button" class="btn btn-default" title="删除主管外经贸部门">
