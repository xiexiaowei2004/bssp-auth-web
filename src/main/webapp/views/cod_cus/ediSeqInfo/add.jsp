...
<body class="gray-bg">
   <div class="container animated fadeInRight">                        
		...
		<div class="ibox-title font-bold">单据编码-新增
			 ...
			 <table class="table table-condensed no-borders no-margins">
		      <tr>
				...
				<td class="table-label text-nowrap text-right">单据类型<span class="notempty">*</span></td>
					<td> 
						<div class="form-group">
							  	<input class="form-control"  id="docType" name="docType"isShowEmpty="true" isValidate="true" notempty ></select>
						</div>   
					</td>
				<td class="table-label text-nowrap text-right">服务类型<span class="notempty">*</span></td>
					<td>
						<div class="form-group">
							 <select class="form-control select2" id="serverType" name="serverType" isValidate="true" notempty>
				...
				<tr>
					<td class="table-label text-nowrap text-right">日期规则</td>
						<td>
							<div class="form-group">
										<select class="form-control select2" id="dateRule" name="dateRule" isShowEmpty="true">
										<option value=" ">--请选择--</option>
