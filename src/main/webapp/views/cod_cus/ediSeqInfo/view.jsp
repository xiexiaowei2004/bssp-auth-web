...
<body class="gray-bg">
   <div class="container animated fadeInRight">                        
		...
		<div class="ibox-title font-bold">单据编码-查阅
		      ...
		      <tr>
				<td class="table-label text-nowrap text-right">监管场所</td>
					<td>
						<div class="form-group">
			               	<select class="form-control select2 " id="areaCode" name="areaCode" dll_name="codStdAreaCode" isShowEmpty="true" style="width: 100%" disabled></select>
			             </div>
		            </td>
				<td class="table-label text-nowrap text-right">单据类型<span class="notempty">*</span></td>
					<td> 
						<div class="form-group">
							  	<input class="form-control"  id="docType" name="docType"isShowEmpty="true" isValidate="true" notempty style="width: 100%" readonly></select>
						</div>   
					</td>
				<td class="table-label text-nowrap text-right">服务类型<span class="notempty">*</span></td>
					<td>
						<div class="form-group">
							 <select class="form-control select2" id="serverType" name="serverType" isValidate="true" notempty style="width: 100%" disabled>
				...
				<tr>
					<td class="table-label text-nowrap text-right">日期规则</td>
						<td>
							<div class="form-group">
										<select class="form-control select2" id="dateRule" name="dateRule" isShowEmpty="true" style="width: 100%" disabled>
										<option value=" ">--请选择--</option>
					...
					<td class="table-label text-nowrap text-right">项目掩码</td>
						<td>
						   <div class="form-group">
							  	<input class="input-sm form-control" id="mask" name="mask" readonly>
						   </div> 
		              	</td>
					<td class="table-label text-nowrap text-right">计数器位数</td>
						<td> 
						 <div class="form-group">
							  <input class="input-sm form-control" id="counterLength" name="counterLength" readonly>
						 </div>   
						</td>
					</tr>
					<tr>
						...
						<td>
						<div class="form-group">
								<input class="input-sm form-control"  id="modelName" name="modelName" readonly>
								</div>
						</td>
						<td class="table-label text-nowrap text-right">是否启用</td>
						  <td>
						   <div class="form-group">
								  <select class="form-control select2" id="status" name="status" isShowEmpty="true" dll_name="IS_ENABLE" style="width: 100%" disabled></select>
							  </div>  
		               </td>
					</tr>
		       </table>
