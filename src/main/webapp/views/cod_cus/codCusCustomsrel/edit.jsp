            ...
            <div class="ibox-content">
                <form id="form" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" maxlength="4" class="form-control" id="customsCode" name="customsCode" >
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label col-sm-offset-1">关区名称<span style="color:red;">*</span>：</label>
                        <div class="col-sm-4">
                            <input type="text" maxlength="16" class="form-control" name="customsName" id="customsName" >
                        </div>
                    </div>
