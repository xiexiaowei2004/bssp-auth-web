...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <form id="searchForm">
            ...
            <div class="ibox-content">
                <div class="row m-b-sm">
                    ...
                    <div class="col-md-3 form-horizontal">
                        <label class="col-sm-3 control-label text-nowrap text-right">主键</label>
                        <div class="col-sm-9">
                     ...
                     <div class="col-md-4 form-horizontal">
                        <label class="col-sm-4 control-label text-nowrap text-right">应用编码</label>
                        <div class="col-sm-8">
       ...
       <!--ibox-->
        <div class="ibox-title font-bold">日志维护</div>
    <div class="ibox-content">
