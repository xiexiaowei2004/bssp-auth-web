            ...
            <div class="ibox-content">
                <form id="form" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" maxlength="10" class="form-control" name="id" placeholder="请填写主键编码">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label col-sm-offset-1">应用编码<span style="color:red;">*</span>：</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="applyId" placeholder="请填写应用编码">
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="ip" placeholder="请填写ip号">
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="type" placeholder="请填写问题类型">
                        </div>
                    </div>
