...
<div class="container animated fadeInRight">
				...
				<div class="ibox-content">
					<div class="row m-b-sm">
						<div class="col-md-4 form-horizontal">
							<label class="col-sm-3 control-label text-nowrap text-right">地区代码</label>
							<div class="col-sm-9">
								<input type="text" class="form-control Col-sm-6" name="districtCode" value="" />
							</div>
						</div>
						<div class="col-md-4 form-horizontal">
							<label class="col-sm-3 control-label text-nowrap text-right">地区名称</label>
							<div class="col-sm-9"> 
                               <input type="text" class="form-control Col-sm-6" name="districtName" value="">
							</div>
						</div>
						<div class="col-md-4 form-horizontal">
							<label class="col-sm-3 control-label text-nowrap text-right">地区类别</label>
							<div class="col-sm-9"> 
                               <input type="text" class="form-control Col-sm-6" name="districtType" value="">
							</div>
						</div>
 ...
 <!--ibox-->
	<div class="ibox-title font-bold">国内地区</div>
		<div class="ibox-content">
			<div class="row">
				<div class="col-md-12">
					<!-- <span class="m-r-sm">
