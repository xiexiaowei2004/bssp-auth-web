...
<div class="container animated fadeInRight">
				...
				<div class="ibox-content">
					<div class="row m-b-sm">
						<div class="col-md-6 form-horizontal">
							<label class="col-sm-3 control-label text-nowrap text-right">保税方式代码</label>
							<div class="col-sm-9">
								<input type="text" class="form-control Col-sm-6" name="payModeCode" value="" />
							</div>
						</div>
						<div class="col-md-6 form-horizontal">
							<label class="col-sm-3 control-label text-nowrap text-right">保税方式名称</label>
							<div class="col-sm-9"> 
                               <input type="text" class="form-control Col-sm-6" name="payModeName" value="">
							</div>
						</div>
 ...
 <!--ibox-->
	<div class="ibox-title font-bold">保税方式</div>
		<div class="ibox-content">
			<div class="row">
				<div class="col-md-12">
					<!-- <span class="m-r-sm">
