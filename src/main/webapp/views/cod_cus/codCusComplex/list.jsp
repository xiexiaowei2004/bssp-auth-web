				...
				<div class="ibox-content">
					<div class="row m-b-sm">
						<div class="col-md-6 form-inline">
							<label class="col-sm-3 control-label text-nowrap text-right">HS编码</label>
							<div class="col-sm-9">
					...
					<div class="row m-b-sm">
						<div class="col-md-6 form-inline">
							<label class="col-sm-3 control-label text-nowrap text-right">第一单位</label>
							<div class="col-sm-9"> 
                               <input type="text" class="form-control Col-sm-6" name="unit1" value="">
							</div>
						</div>
						<div class="col-md-6 form-inline">
							<label class="col-sm-3 control-label text-nowrap text-right">第二单位</label>
							<div class="col-sm-9"> 
                               <input type="text" class="form-control Col-sm-6" name="unit2" value="">
							</div>
						</div>
					</div>	
