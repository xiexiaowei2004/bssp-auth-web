...
<div class="container animated fadeInRight">
				...
				<div class="ibox-content">
					<div class="row m-b-sm">
						<div class="col-md-6 form-horizontal">
							<label class="col-sm-3 control-label text-nowrap text-right">加工类别代码</label>
							<div class="col-sm-9">
								<input type="text" class="form-control Col-sm-6" name="busiCode" value="" />
							</div>
						</div>
						<div class="col-md-6 form-horizontal">
							<label class="col-sm-3 control-label text-nowrap text-right">加工类别</label>
							<div class="col-sm-9"> 
                               <input type="text" class="form-control Col-sm-6" name="busiName" value="">
							</div>
						</div>
 ...
 <!--ibox-->
	<div class="ibox-title font-bold">加工类别</div>
		<div class="ibox-content">
			<div class="row">
				<div class="col-md-12">
					<!-- <span class="m-r-sm">
