...
<div class="container animated fadeInRight">
				...
				<div class="ibox-content">
					<div class="row m-b-sm">
						<div class="col-md-4 form-horizontal">
							<label class="col-sm-4 control-label text-nowrap text-right">征免性质代码</label>
							<div class="col-sm-8">
								<input type="text" class="form-control Col-sm-6" name="cutMode" value="" />
							</div>
						</div>
						<div class="col-md-4 form-horizontal">
							<label class="col-sm-4 control-label text-nowrap text-right">征免性质简称</label>
							<div class="col-sm-8"> 
                               <input type="text" class="form-control Col-sm-6" name="abbrCut" value="">
							</div>
						</div>
						<div class="col-md-4 form-horizontal">
							<label class="col-sm-4 control-label text-nowrap text-right">征免性质全称</label>
							<div class="col-sm-8"> 
                               <input type="text" class="form-control Col-sm-6" name="fullCut" value="">
							</div>
						</div>
 ...
 <!--ibox-->
	<div class="ibox-title font-bold">征免性质</div>
		<div class="ibox-content">
			<div class="row">
				<div class="col-md-12">
					<!-- <span class="m-r-sm">
