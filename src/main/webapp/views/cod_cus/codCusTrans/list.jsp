...
<div class="container animated fadeInRight">
				...
				<div class="ibox-content">
					<div class="row m-b-sm">
						<div class="col-md-6 form-horizontal">
							...
							<div class="col-sm-9">
								<input type="text" class="form-control Col-sm-6" name="transMode" value="" />
							</div>
						</div>
						<div class="col-md-6 form-horizontal">
							<label class="col-sm-3 control-label text-nowrap text-right">成交方式</label>
							<div class="col-sm-9"> 
                               <input type="text" class="form-control Col-sm-6" name="transSpec" value="">
							</div>
						</div>
 ...
 <!--ibox-->
	<div class="ibox-title font-bold">成交方式</div>
		<div class="ibox-content">
			<div class="row">
				<div class="col-md-12">
					<!-- <span class="m-r-sm">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="input-group col-sm-10" id="datepicker">
                                    <input type="text" class="form-control" name="transMode" value="" />
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="transSpec" value="">
                            ...
                            <div class="example-wrap">
                                <div class="example">
                                    <div id="toolbar" class="btn-group m-t-sm">
                                        <button id="add" type="button" class="btn btn-default"  title="创建成交方式">
                                            <i class="glyphicon glyphicon-plus"></i>
                                        </button>
                                        <button id="delete" type="button" class="btn btn-default" title="删除成交方式">
...
<tiziFooter>
    ...
    <script src="../../../static/cod_cus/js/codCusTrans.js"></script>
</tiziFooter>
<script>
    $(function () {
        load();
