...
<div class="container animated fadeInRight">
				...
				<div class="ibox-content">
					<div class="row m-b-sm">
						<div class="col-md-6 form-horizontal">
							<label class="col-sm-3 control-label text-nowrap text-right">许可证件代码</label>
							<div class="col-sm-9">
								<input type="text" class="form-control Col-sm-6" name="docuCode" value="" />
							</div>
						</div>
						<div class="col-md-6 form-horizontal">
							<label class="col-sm-3 control-label text-nowrap text-right">许可证件名称</label>
							<div class="col-sm-9"> 
                               <input type="text" class="form-control Col-sm-6" name="docuName" value="">
							</div>
						</div>
 ...
 <!--ibox-->
	<div class="ibox-title font-bold">许可证件</div>
		<div class="ibox-content">
			<div class="row">
				<div class="col-md-12">
					<!-- <span class="m-r-sm">
                    ...
                    <form  method="post" id="searchForm">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="control-label">许可证件代码</label>
                                <div class="input-group col-sm-10" id="datepicker">
                                    <input type="text" class="form-control" name="docuCode" value="" />
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="control-label">许可证件名称</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" name="docuName" value="">
                            ...
                            <div class="example-wrap">
                                <div class="example">
                                    <div id="toolbar" class="btn-group m-t-sm">
                                        <button id="add" type="button" class="btn btn-default"  title="创建许可证件">
                                            <i class="glyphicon glyphicon-plus"></i>
                                        </button>
                                        <button id="delete" type="button" class="btn btn-default" title="删除许可证件">
