...
<div class="container animated fadeInRight">
				...
				<div class="ibox-content">
					<div class="row m-b-sm">
						<div class="col-md-6 form-horizontal">
							<label class="col-sm-3 control-label text-nowrap text-right">计量单位代码</label>
							<div class="col-sm-9">
								<input type="text" class="form-control Col-sm-6" name="unitCode" value="" />
							</div>
						</div>
						<div class="col-md-6 form-horizontal">
							<label class="col-sm-3 control-label text-nowrap text-right">计量单位</label>
							<div class="col-sm-9"> 
                               <input type="text" class="form-control Col-sm-6" name="unitName" value="">
							</div>
						</div>
 ...
 <!--ibox-->
	<div class="ibox-title font-bold">计量单位</div>
		<div class="ibox-content">
			<div class="row">
				<div class="col-md-12">
					<!-- <span class="m-r-sm">
                    ...
                    <form  method="post" id="searchForm">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label class="control-label">计量单位代码</label>
                                <div class="input-group col-sm-10" id="datepicker">
                                    <input type="text" class="form-control" name="unitCode" value="" />
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6">
