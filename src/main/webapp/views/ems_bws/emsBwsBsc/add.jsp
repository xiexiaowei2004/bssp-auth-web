    ...
    <div class="ibox" id="head">      
      ...
      <div class="ibox-title no-margins">
        <div class="pull-left">
            ...
            <a href="#1" class="btn btn-success fa fa-check-square-o" id="submit">申报</a>
		        ...
		        <td class="table-label text-nowrap text-right">统一编码：</td>
		           ...
		           <tr>
		           	<td class="table-label text-nowrap text-right">结束有效日期:</td>
						...
						<td>
						<select class="form-control"  id="ownerSystem" name="ownerSystem" dll_name="OWNER_SYSTEM" ></select>
					</td>      
		           </tr>
		           <tr>
