...
<title>账册变更</title>
<link rel="stylesheet"
	href="../../../static/common/bootstrap-table-master/bootstrap-table.min.css" />
<link rel="stylesheet"
	href="../../../static/common/bootstrap-datepicker-master/css/bootstrap-datepicker3.min.css" />
<link rel="stylesheet"
	href="../../../static/common/bootstrap/css/bootstrap.min.css" />
<link rel="stylesheet"
	href="../../../static/common/font-awesome/css/font-awesome.min.css" />
<link rel="stylesheet"
	href="../../../static/common/select2/css/select2.min.css"
	type="text/css">
<link rel="stylesheet"
	href="../../../static/common/bootstrapvalidator-master/css/bootstrapValidator.min.css"
	type="text/css">
		        ...
		        <td class="table-label text-nowrap text-right">统一编码：</td>
		           ...
		           <tr>
		              <td class="table-label text-nowrap text-right">经营企业编号：</td>
						...
						<td colspan="3"><input class="form-control"  id="bizopEtpsNm" name="bizopEtpsNm" readonly></td>
	               </tr>
		           <tr>
		           ...
		           <tr>
						...
						<td colspan="3"><input class="form-control" id="dclEtpsNm" name="dclEtpsNm" readonly></td>
		           </tr>
		           <tr>
		           	<td class="table-label text-nowrap text-right">申报单位类型：</td>
						<td>
		               		<select class="form-control " id="dclEtpsTypecd" name="dclEtpsTypecd" dll_name="DCL_ETPS_TYPE" disabled></select>
		               </td>
						<td class="table-label text-nowrap text-right">申报时间：</td>
						<td><input class="form-control"  id="dclTime" name="dclTime" readonly>
						</td>
						<td class="table-label text-nowrap text-right">审批状态:</td>
						<td><div class="select2-width" >
	               			<select class="form-control "  id="emapvStucd" name="emapvStucd" dll_name="CHK_STATUS" disabled></select></div>
		               </td>	                       
		           </tr>
		           <tr>
		           	<td class="table-label text-nowrap text-right">结束有效日期:</td>
						...
						<td>
						<select class="form-control"  id="appendTypecd" name="appendTypecd" dll_name="EMS_TYPE" readonly></select>
		           ...
		           <tr>
		              <td class="table-label text-nowrap text-right">企业备案号：</td>
						<td><input class="form-control"  id="copEntNo" name="copEntNo" readonly></td>
						<td class="table-label text-nowrap text-right">监管场所:</td>
						   <td>
		               		<select class="form-control" id="areaCode" name="areaCode" dll_name="codStdAreaCode" disabled></select>
		               </td>
		           ...
		           <tr>
						<td class="table-label text-nowrap text-right">申报类型：</td>
						  <td>
			               	<select class="form-control select2 " id="dclTypecd" name="dclTypecd" dll_name="DCL_TYPECD_BWS" disabled>
			              	</select>
		               </td>
						...
						<td><input class="form-control"  id="contactEr" name="contactEr" ></td>
					</tr>
					<tr>
						<td class="table-label text-nowrap text-right">联系电话：</td>
						<td><input class="form-control"  id="contactTele" name="contactTele" ></td>
					</tr>
		       </table>
				</form>
			</div>
...
<div class="ibox">
        ...
        <div class="ibox-title">
            <h4 class="box-title pull-left">明细信息列表</h4>
            <div class="pull-right">
                <a href="#1" class="collapse-link" title="收起表头"><i class="fa fa-chevron-up"></i></a>
            </div>
        </div>
        <div class="ibox-content">
            <div class="box-body" id="Dtfile">
                <div id="DtToolbar">
                    <a href="#1" class="btn btn-info fa fa-info-circle" id="DtView">查阅</a>
					<a href="#1" class="btn btn-info fa fa-plus-square" id="DtAdd">新增</a>
					<a href="#1" class="btn btn-info fa fa-edit" id="DtModify">修改</a>
					<a href="#1" class="btn btn-info fa fa-remove" id="DtDelete">删除</a>
                </div>
        ...
        <div class="ibox-content">
            <div class="box-body" id="file">
                <div id="fileToolbar">
					...
					<a href="#1" class="btn btn-info fa fa-plus-square" id="acmpFormDtAdd">新增</a>
					<a href="#1" class="btn btn-info fa fa-edit" id="acmpFormDtModify">修改</a>
					<a href="#1" class="btn btn-info fa fa-remove" id="acmpFormDtDelete">删除</a>
                </div>
	...
	<footer>
		...
		<script
			src="../../../static/admin/main/js/metisMenu/jquery.metisMenu.js"></script>
		<script
			src="../../../static/admin/main/js/slimscroll/jquery.slimscroll.min.js"></script>
		<!-- jquery-ui-->
		...
		<!-- Bootstrap table -->
		<script
			src="../../../static/common/bootstrap-table-master/bootstrap-table.min.js"></script>
		<script
			src="../../../static/common/bootstrap-table-master/extensions/export/bootstrap-table-export.js"></script>
		<script
			src="../../../static/common/bootstrap-table-master/tableExport.js"></script>
		<script
			src="../../../static/common/bootstrap-table-master/locale/bootstrap-table-zh-CN.min.js"></script>
		<script src="../../../static/common/select2/js/select2.full.js"></script>
		<script src="../../../static/common/select2/js/i18n/zh-CN.js"></script>
		<script
			src="../../../static/common/bootstrap-table-master/extensions/export/bootstrap-table-export.js"></script>
		<script
			src="../../../static/common/bootstrapvalidator-master/js/bootstrapValidator.min.js"></script>
		<script
			src="../../../static/common/bootstrapvalidator-master/js/language/zh_CN.js"></script>
		<!-- Data picker -->
		<script
			src="../../../static/common/bootstrap-datepicker-master/js/bootstrap-datepicker.js"></script>
		<!-- 自定义js -->
