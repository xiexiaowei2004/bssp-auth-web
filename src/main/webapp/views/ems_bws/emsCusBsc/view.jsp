...
<div class="container animated fadeInRight">
    <div class="ibox" id="head">
        <div class="ibox-title with-border collapsed-box">
            <div class="pull-left">
                <h4 class="box-title pull-left">物流账册查询</h4>
            </div>
            ...
            <form id="dataForm">
                <table class="table table-condensed no-borders no-margins">
                    ...
                    <tr>
                        ...
                        <td>
                        	<div class="form-group">
                        		<input class="form-control" id="houseArea" name="houseArea" type="number" step="0.00001"  isValidate="true" notempty>
                       		</div>
                       	</td>
    ...
    <div class="ibox">
        ...
        <div class="ibox-title">
            ...
            <div class="pull-right">
                <a href="#1" class="collapse-link" title="收起"><i class="fa fa fa-chevron-down"></i></a>
            </div>
        </div>
        <div class="ibox-content" style="display:none;">
            <div class="box-body">
                <div id="fileToolbar">
                    <a href="#1" class="btn btn-info fa fa-info-circle" id="fileView">查阅</a>
                    <a href="#1" class="btn btn-info fa fa-plus-square" id="fileAdd">新增</a>
                    <a href="#1" class="btn btn-info fa fa-edit" id="fileEdit">修改</a>
                    <a href="#1" class="btn btn-info fa fa-remove" id="fileDelete">删除</a>
                </div>
...
<footer>
    ...
    <script src="../../../static/ems_bws/js/emsBwsCus_form.js"></script>
