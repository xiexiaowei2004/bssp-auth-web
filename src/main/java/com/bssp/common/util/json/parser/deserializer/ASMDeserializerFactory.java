...
import static com.bssp.common.util.ASMUtils.getDesc;
import static com.bssp.common.util.ASMUtils.getType;
...
import com.bssp.common.util.ASMClassLoader;
...
import com.bssp.common.util.json.asm.ClassWriter;
import com.bssp.common.util.json.asm.FieldVisitor;
import com.bssp.common.util.json.asm.Label;
import com.bssp.common.util.json.asm.MethodVisitor;
import com.bssp.common.util.json.asm.Opcodes;
...
import com.bssp.common.util.json.parser.ParseContext;
import com.bssp.common.util.json.parser.ParserConfig;
import com.bssp.common.util.json.parser.SymbolTable;
import com.bssp.common.util.json.parser.DefaultJSONParser.ResolveTask;
import com.bssp.common.util.json.parser.deserializer.ASMJavaBeanDeserializer.InnerJavaBeanDeserializer;
...
public class ASMDeserializerFactory implements Opcodes {
            ...
            if (fieldClass == boolean.class) {
                ...
                if (actualTypeArgument instanceof Class) {
                    ...
                    if (itemClass == String.class) {
                        mw.visitLdcInsn(com.bssp.common.util.json.asm.Type.getType(getDesc(fieldClass))); // cast
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitLdcInsn(com.bssp.common.util.json.asm.Type.getType(getDesc(itemType)));
    ...
    private void _deserialze_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, getType(DefaultJSONParser.class), "getConfig", "()"
                                                                                         + getDesc(ParserConfig.class));
        mw.visitLdcInsn(com.bssp.common.util.json.asm.Type.getType(getDesc(fieldInfo.getFieldClass())));
        mw.visitMethodInsn(INVOKEVIRTUAL, getType(ParserConfig.class), "getDeserializer",
                           "(" + getDesc(Type.class) + ")" + getDesc(ObjectDeserializer.class));
